...
class ButterflyNet(nn.Module):
    ...
    def forward(self, inputs):
        ...
        up4 = self.up_concat4(attention4_bmode, center_bmode)
        ...
        up3 = self.up_concat3(attention3_bmode, up4)
        ...
        up2 = self.up_concat2(attention2_bmode, up3)
        ...
        up1 = self.up_concat1(attention1_bmode, up2)
