...
from .utils import unetConv2, unetUp3
...
class DopUsNet(nn.Module):
    ...
    def __init__(self, feature_scale=8, n_classes=1, is_deconv=True, in_channels=1, is_batchnorm=True):
        ...
        self.convGRUBmode = ConvGRU(input_size=filters[4], hidden_sizes=[64, 64, 128],
                                    kernel_sizes=[3, 3, 5], n_layers=3)
    ...
    def forward(self, inputs, hidden):
        ...
        up4 = self.up_concat4(conv4_bmode, conv4_doppler, center)
        ...
        up3 = self.up_concat3(conv3_bmode, conv3_doppler, up4)
        ...
        up2 = self.up_concat2(conv2_bmode, conv2_doppler, up3)
        ...
        up1 = self.up_concat1(conv1_bmode, conv1_doppler, up2)
